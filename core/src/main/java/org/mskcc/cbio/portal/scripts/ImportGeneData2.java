...
public class ImportGeneData2 {
        ...
        try (FileReader reader = new FileReader(geneFile)) {
            ...
            while ((line = buf.readLine()) != null) {
                ...
                if (line.startsWith("#")) {
                    ...
                    if (taxonimy!=9606) {
                        // only import human genes THIS HAS TO CHANGE FROM 9606 TO 10090
                        continue;
                    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ImportGeneData2.importData(geneFile);
        ...
        if (args.length>=2) {
            ...
            System.out.println(" --> total number of lines:  " + numLines);
            ProgressMonitor.setMaxValue(numLines);
            ImportGeneData2.importSuppGeneData(suppGeneFile);
        }
        ...
        if (args.length>=4) {
            ...
            System.out.println(" --> total number of lines:  " + numLines);
            ProgressMonitor.setMaxValue(numLines);
            ImportGeneData2.importGeneLength(lociFile);
        }
    }
}
